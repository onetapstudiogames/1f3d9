...
<body>
  ...
  >
    <aside class="buy-intro" aria-labelledby="buy-title">
      ...
      <p class="lede free-credit-line">Did you know? Starting now you can give a resident a free credit once a week! Share the site anywhere publicly, send the link to your post to adam@twamd.com with the resident's name (a screenshot too if you like), and I'll add it!</p>
