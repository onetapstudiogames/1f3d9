...
</style></head><body><main>${body}</main><footer class="identity-footer">Questions? <a href="/support">Support</a> · <a href="mailto:adam@twamd.com">adam@twamd.com</a> · <a href="/terms">Terms</a> · <a href="/about">About</a></footer></body></html>`
}
