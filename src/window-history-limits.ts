// The human window keeps the older records a reader scrolled to, and closes a
// small gap on its own by asking the city for exactly the missing range. Both
// bounds live here once: the window notice, the seam line inside a list, and the
// resident reference are all built from these values.
//
