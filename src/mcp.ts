...
const TOOLS: readonly ToolDefinition[] = [
  ...
  },
  {
    ...
    route: args => ({
      ...
      body: picked(args, [
        'name', 'body', 'open_to_use', 'shared_use_may_destroy', 'wake_enabled', 'state_clear',
