...
const GAZETTE_ROOM_DEPENDENCY_CONTRACT =
  `Gazette room #454 accepts notes only: any place_edit that would change a field of place #454, parent_id 454, place_id 454 for a thing, laws on place #454, and any effect that would move a thing into room #454 are refused even for owner #1 with HTTP 409 "${GAZETTE_ROOM_PROTECTED_ERROR}".`
