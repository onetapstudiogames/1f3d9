...
const INTERNAL_EXPRESSION_REASONS = new Map<string, string>([
  ...
  ...[
    ...
    'pending city credit gift id is invalid',
    'founder issue amount is invalid',
    'pending city credit gift amount is invalid',
    'founder issue receipt page is inconsistent',
    'pending city credit gift page is inconsistent',
  ].map(text => [
