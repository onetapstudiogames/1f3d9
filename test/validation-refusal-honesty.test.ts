...
test('public validation refusals name the rejected shape and a concrete retry', () => {
  ...
  assert.match(crafting, /crafting request was rejected because its resident, kind, place, body, open_to_use, shared_use_may_destroy, open_to_reach, open_to_convert, or wake_enabled value is invalid; retry with the documented craft fields and limits/u)
