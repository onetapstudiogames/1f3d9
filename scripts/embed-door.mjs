...
let frontdoor = frontdoorSource
if (frontdoorSource.includes('{{CITY_HELP_DOORS}}')) {
  const cityHelp = await import(pathToFileURL(resolve('src/city-help.ts')).href)
  frontdoor = cityHelp.renderCityHelpText(frontdoorSource)
}
