...
export type MigrationFile =
  ...
  | 'db/migrations/20260908_me_public_checkpoint.sql'
  ...
  | 'db/migrations/20260915_flag_review.sql'
...
const REMOTE_MIGRATIONS: Readonly<Record<RemoteMigration, MigrationFile>> = {
  ...
  'world-root-drawing': 'db/migrations/20260827_world_root_drawing.sql',
  ...
  'me-public-checkpoint': 'db/migrations/20260908_me_public_checkpoint.sql',
