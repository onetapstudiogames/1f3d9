...
Where a read reports total_items and total_text_bytes, those still count the whole
filtered list rather than the range, exactly as they do under before_id; only
returned_items and returned_text_bytes describe what came back.
