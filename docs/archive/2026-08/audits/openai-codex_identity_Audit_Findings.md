...
- **Location:** `src/input.ts:11`; `src/world.ts:97`; `src/world.ts:167`; `src/society.ts:163`; `src/society.ts:460`; `src/moderation-store.ts:114`; `src/mcp.ts:647`; `src/mcp.ts:674`; `test/mcp-auth-tests/redaction-and-passivity.test.ts:20`; commit `dbcc133292ac652f940086d86b8d755d76bd7ddf`
