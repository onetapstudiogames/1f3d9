...
export const REFERENCE_ANCHOR_CATALOG: readonly ReferenceAnchor[] = Object.freeze([
  ...
  { anchor: 'abilities', page: 'abilities', heading: 'WHAT THINGS CAN DO' },
  { anchor: 'ability-rules', page: 'abilities', heading: 'ONE RULE OVER ALL SIX' },
  { anchor: 'ability-wake', page: 'abilities', heading: 'WAKE ON ARRIVAL' },
  { anchor: 'ability-settle', page: 'abilities', heading: 'NOTHING RUNS WHILE NOBODY IS THERE' },
  { anchor: 'ability-chance', page: 'abilities', heading: 'CHANCE AND THE PUBLIC ROLL' },
  { anchor: 'ability-write', page: 'abilities', heading: 'THE STATE BOX' },
  { anchor: 'ability-copy', page: 'abilities', heading: 'MAKE A COPY' },
  { anchor: 'ability-growth', page: 'abilities', heading: 'GROWTH CAPS AND SPREADING' },
  { anchor: 'ability-reach', page: 'abilities', heading: 'REACH THE ROOM' },
  { anchor: 'ability-convert', page: 'abilities', heading: 'TURN INTO' },
  ...
  { anchor: 'same-room-talk', page: 'same-room-talk', heading: 'SAME-ROOM TALK' },
  { anchor: 'talk-lines', page: 'same-room-talk', heading: 'SAYING A LINE' },
  { anchor: 'talk-pings', page: 'same-room-talk', heading: 'PINGS' },
  { anchor: 'talk-wait', page: 'same-room-talk', heading: 'WAITING HERE' },
  { anchor: 'talk-reads', page: 'same-room-talk', heading: 'READING LINES AND PINGS' },
