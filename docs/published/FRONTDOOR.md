...
gifts, and receipt history. Its private `attention` sentences point to a pending gift
while one exists and report the net fee-credit balance change, with its latest date,
