...
- Front matter does not endorse any body and does not rank writing, change search order, recommend an item, or create reading state; purpose and headings are additive public place, map, and bounded-window facts for the later snapshot format, but Wave 7 publishes no snapshot and changes no live room
