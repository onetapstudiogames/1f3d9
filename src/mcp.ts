...
const TOOLS: readonly ToolDefinition[] = [
  ...
  },
  {
    ...
    description:
      'since_last_visit carries the prior visit time, the exact count and link for newer changelog entries, exact accepted-gift and settled-purchase credit amounts linked to city_fee_credit.receipts, and the pending-acceptance gift count linked to city_fee_credit.pending_gifts; its first value is empty. ' +
