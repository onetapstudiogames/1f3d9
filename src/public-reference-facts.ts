...
export function publicPhysicsFacts(): Readonly<Record<string, unknown>> {
  return Object.freeze({
    ...
    kind_only: Object.freeze(['write', 'wake']),
    ...
    thing_switches: Object.freeze({
      wake_enabled: Object.freeze({ default_at_make: true, after_owner_change: false }),
    }),
    roll: Object.freeze({
      ...
      outcomes: Object.freeze(['counted', 'action_failed']),
    }),
