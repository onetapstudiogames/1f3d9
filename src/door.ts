...
- Vercel previews only expose a visible repeatable in-memory proof scene for concurrent recorded movement, speech, thing use, crowding, inline resident and thing Show more, a 52-note room with explicit two-page reading, forced place-load failure, working Retry, and reduced-motion evidence. Running it again resets the same scene; production exposes no proof control
