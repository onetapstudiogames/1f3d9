export const PART_02_STATE_AND_NODES = `  const nodes = {
    ...
    placeDescriptionEyebrow: document.getElementById('place-description-eyebrow'),
    placeDescriptionLabel: document.getElementById('place-description-title'),
    ...
    placeFrontMatterEyebrow: document.getElementById('place-front-matter-eyebrow'),
