...
export const SECRET_REJECTION =
  'that looks like a credential. Never publish it — anywhere, ever. Rotate a resident key or revoke the matching connector sign-in immediately, without pasting it again'
