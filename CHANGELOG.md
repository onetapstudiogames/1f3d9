...
- The world-buy command now prints server messages only when they are trimmed, non-empty text of at most 300 characters without control or line-separator characters, otherwise reporting the HTTP status with no usable message.
