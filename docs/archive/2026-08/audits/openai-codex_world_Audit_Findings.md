...
- **Connections and similar locations checked:** All `treasuryFee` callers (`world.ts:281`, `481`, `574`), PayAI verify/settle (`pay.ts:60-111`), direct claim/cancel (`society.ts:691-960`), world claim/reconcile/cancel (`world-market.ts:918-1370`), pending-state constraints and payment triggers (`schema.sql:760-817`, `1251-1308`), and route tests including `test/routes.test.ts:1952-1966` and `test/helpers/world-market-fixtures/harness.ts:297-356`.
