...
export const PUBLIC_SNAPSHOT_CLASS_REGISTRY: readonly SnapshotClassRegistryEntry[] =
  Object.freeze(([
    ...
    { class_name: 'ability_runtime', disposition: 'not_exported', reason: 'wake settles and tries, public chance rolls, state-box history, wake anchors, and the wake and state columns are live public records not carried by format v2 yet', database_sources: ['wake_settles', 'wake_tries', 'chance_rolls', 'thing_state_changes', 'thing_wake_state', 'things.wake_enabled', 'things.state', 'things.state_version', 'places.wake_visitors', 'places.wake_pins', 'places.wake_block_thing_ids', 'places.wake_block_resident_ids', 'places.wake_random_cap', 'places.rough_room', 'places.rough_since', 'resident_presence.arrived_at'] },
