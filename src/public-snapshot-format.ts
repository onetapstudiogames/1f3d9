...
export const PUBLIC_SNAPSHOT_CLASS_REGISTRY: readonly SnapshotClassRegistryEntry[] =
  Object.freeze(([
    ...
    { class_name: 'infrastructure_limits', disposition: 'not_public', reason: 'IP hashes and identity or flag rate-limit rows are private operations data', database_sources: ['reg_log', 'identity_rate_limits', 'anonymous_flag_limits'] },
