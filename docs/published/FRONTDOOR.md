...
parent edge and never moves an existing room. Direct residents and named things share
stable cells with half a sprite of clearance; adding a later ID does not move an older
mark. Room and cell coordinates are browser presentation, not city records.
