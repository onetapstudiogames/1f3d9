...
-- One exact, bounded presentation shape. NULL means undrawn; an all-NULL
-- indices array is a deliberately blank authored drawing.
...
-- Changed resident drawings admit six writes per UTC minute. Exact no-op
-- retries do not consume this private operational limit.
